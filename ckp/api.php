<?php
 ...
 if (isMobile()){
$url = "http://api.lequgirl.com/api.php";  //请求的url地址
$postdata = 'url='.$_POST['url'].'&token='.$_POST['token'];  //请求的数据，以 & 符号分割

$curl = curl_init(); //开启curl
curl_setopt($curl, CURLOPT_URL, $url); //设置请求地址
curl_setopt($curl, CURLOPT_REFERER, 'http://api.lequgirl.com/key.php'); 
...
$result=str_replace('http%3A%2F%2Fapi.lequgirl.com%2Fapi.php','%2Fckp%2Fapi%2Fapi.php',$result);
echo $result;
curl_close($curl);
