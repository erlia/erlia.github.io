<?php
 ...
 if (isMobile()){
$url = "http://www.dgua.xyz/webcloud/p1/api.php";  //请求的url地址
$postdata = 'url='.$_POST['url'];  //请求的数据，以 & 符号分割
$curl = curl_init(); //开启curl
curl_setopt($curl, CURLOPT_URL, $url); //设置请求地址
curl_setopt($curl, CURLOPT_REFERER, 'http://www.dgua.xyz/webcloud/p1/api.php'); 
...
$result=str_replace('\/webcloud\/api\/p1\/api.php','\/webcloud\/api\/api.php',$result);
echo $result;
curl_close($curl);
