<?php
 ...
 if (isMobile()){
$url = "http://www.0335haibo.com/api.php";  //请求的url地址
$postdata = 'time='.$_POST['time'].'&key='.$_POST['key'].'&url='.$_POST['url'].'&type='.$_POST['type'];  //请求的数据，以 & 符号分割
...
$result=str_replace('http:\/\/www.0335haibo.com\/api.php','\/ppucms\/api\/api.php',$result);
echo $result;
curl_close($curl);
