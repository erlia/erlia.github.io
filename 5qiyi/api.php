<?php
 ...
 if (isMobile()){
$url = "http://www.jiexi.cx/5qiyi/api.php";  //请求的url地址
$postdata = 'url='.$_POST['url'].'&debug='.$_POST['debug'];  //请求的数据，以 & 符号分割
$curl = curl_init(); //开启curl
curl_setopt($curl, CURLOPT_URL, $url); //设置请求地址
curl_setopt($curl, CURLOPT_REFERER, 'http://www.jiexi.cx/5qiyi/'); 
...
$result=str_replace('http://www.me26.com/ad/','',$result);
$result=str_replace('http://www.me26.com','',$result);
...
$result=str_replace('http://www.me26.com/ad/','',$result);
$result=str_replace('http://www.me26.com','',$result);
$result=str_replace('http://play.jiexi.cx/api/jiexi.php','\/5qiyi\/api\/api.php',$result);
echo $result;
curl_close($curl);
