<?php
 ...
 if (isMobile()){
$url = "http://jx.api.163ren.com/api.php";  //请求的url地址
$postdata = 'url='.$_POST['url'].'&sign='.$_POST['sign'];  //请求的数据，以 & 符号分割
$curl = curl_init(); //开启curl
curl_setopt($curl, CURLOPT_URL, $url); //设置请求地址
curl_setopt($curl, CURLOPT_REFERER, 'http://jx.api.163ren.com/api.php'); 
...
$result=str_replace('\/api.php','\/renren\/api\/api.php',$result);
echo $result;
curl_close($curl);
