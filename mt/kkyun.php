...
$curl = curl_init(); 
curl_setopt($curl, CURLOPT_URL, 'http://z.000o.cc/jx/kkyun.php?vid='.$_GET['vid']); 
curl_setopt($curl, CURLOPT_REFERER, 'http://z.000o.cc/jx/kkyun.php?vid='.$_GET['vid']);
...
$result=str_replace('强强视频解析','解析使用交流群',$result);
$result=str_replace('/jx/ckplayer/','/ckplayer/',$result);
$result=str_replace("<script src='http://m.hebeidemao.com/vs-21624'></script>","",$result);
$result=str_replace('1261593947','',$result);
curl_close($curl); 
echo $result;
 }else{
